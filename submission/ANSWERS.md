...
```
$ curl http://localhost:8000/djangoapp/dealer/7/

{"status": 200, "dealer": {"id": 7, "full_name": "Wichita Premier Auto Group", "short_name": "Wichita Premier Auto", "address": "2900 N Ridge Rd", "city": "Wichita", "state": "Kansas", "zip": "67205", "lat": 37.6872, "long": -97.3301}}
```
...
{"status": 200, "dealers": [{"id": 7, "full_name": "Wichita Premier Auto Group", "short_name": "Wichita Premier Auto", "address": "2900 N Ridge Rd", "city": "Wichita", "state": "Kansas", "zip": "67205", "lat": 37.6872, "long": -97.3301}]}
```
...
## Frage 22 (Task 23) — CICD (AKTUALISIERT)
```
GitHub Actions: Django CI (run 33156605501, main branch)

✓ frontend-lint in 27s
  ✓ Set up job
  ✓ Checkout repository
  ✓ Set up Node
...
View run: https://github.com/arslanm-ua/cars-dealership-capstone/actions/runs/33156605501
```
